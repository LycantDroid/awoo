...
Last README file update: Fri Dec 12 21:30:25 CST 2025
...
command.combees
command.combees.dump
command.combees.dump.biomes
command.combees.dump.effects
command.combees.dump.species
...
command.goety.misc.set_damage
command.goety.misc.set_damage.targets
command.goety.misc.set_damage.targets.amount
...
command.multiplayerspawners
command.multiplayerspawners.allow_break
command.multiplayerspawners.allow_break.x
command.multiplayerspawners.allow_break.x.y
command.multiplayerspawners.allow_break.x.y.z
command.multiplayerspawners.torch
command.multiplayerspawners.torch.delay
command.multiplayerspawners.torch.delay.seconds
command.multiplayerspawners.torch.info
command.mute
command.mute.player
...
command.stardew_fishing
command.stardew_fishing.start_minigame
command.stardew_fishing.start_minigame.item
command.starterkit
...
command.structure_gel.getspawns.waterfowl
...
command.worldhost
command.worldhost.ip
command.worldhost.tempip
command.zerocore
